...
export class NgxSeoService {
  ...
  setTitle(title: string): void {
    const titleSuffixBefore = this.config.titleSuffixBefore
      ? this.config.titleSuffixBefore
      : '';
    const titleSuffixAfter = this.config.titleSuffixAfter
      ? this.config.titleSuffixAfter
      : '';

    title = `${titleSuffixBefore}${title}${titleSuffixAfter}`;

    const ogTitle: MetaDefinition = {
      property: NGX_SEO_TITLE_KEYS.OG_TITLE,
      content: title,
    };
    const twitterTitle: MetaDefinition = {
      name: NGX_SEO_TITLE_KEYS.TWITTER_TITLE,
      content: title,
    };
  ...
  setMetaDescription(metaDescription: string): void {
    ...
    const ogDescription: MetaDefinition = {
      property: NGX_SEO_META_KEYS.OG_DESCRIPTION,
      content: metaDescription,
    };
    const twitterDescription: MetaDefinition = {
      name: NGX_SEO_META_KEYS.TWITTER_DESCRIPTION,
      content: metaDescription,
    };
  ...
  setMetaType(metaType: string): void {
    const ogType: MetaDefinition = {
      property: NGX_SEO_META_KEYS.OG_TYPE,
      content: metaType,
    };
  ...
  setMetaCard(metaCard: string): void {
    const twitterCard: MetaDefinition = {
      name: NGX_SEO_META_KEYS.TWITTER_CARD,
      content: metaCard,
    };
  ...
  setMetaImage(metaImage: string): void {
    const ogImage: MetaDefinition = {
      property: NGX_SEO_META_KEYS.OG_IMAGE,
      content: metaImage,
    };
    const twitterImage: MetaDefinition = {
      name: NGX_SEO_META_KEYS.TWITTER_IMAGE,
      content: metaImage,
    };
  ...
  setMetaUrl(metaUrl: string): void {
    const ogUrl: MetaDefinition = {
      property: NGX_SEO_META_KEYS.OG_URL,
      content: metaUrl,
    };
    const twitterUrl: MetaDefinition = {
      name: NGX_SEO_META_KEYS.TWITTER_URL,
      content: metaUrl,
    };
